...
const Footer = () => {
  ...
  <footer class="bg-white">
    ...
    <h2 class="text-2xl font-bold text-gray-900 sm:flex ml-2 mb-10">FoodRecipe</h2>
      <div class=" lg:gap-8">
        ...
        <div class="mt-8 grid grid-cols-3 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
          <div class="">
            <div>
...
FL 33134 USA
          ...
          <div class="">
            <ul class="mt-6 space-y-4 text-sm">
              <li>
                <a href="#" class="text-gray-700 transition hover:opacity-75"> Trang chủ </a>
              </li>
  
              <li>
                <a href="#" class="text-gray-700 transition hover:opacity-75"> Về chúng tôi </a>
              </li>
              <li>
                <a href="#" class="text-gray-700 transition hover:opacity-75"> Liên lạc </a>
              </li>
            </ul>
          </div>
  
          <div class=" col-span-3 lg:flex lg:items-end">
            <form class="w-full">
