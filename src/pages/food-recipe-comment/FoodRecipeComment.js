import CommentBreadCrumb from "./CommentBreadCrumb";
      ...
      <div className={styles.userComment}>
        ...
        <div className="my-8 mx-12">
          <div className="flex mb-7">
            <img
              src="https://i.pinimg.com/1200x/2a/65/3d/2a653d923281fcd64be38a76fc70ef76.jpg"
              alt="avatar"
            ...
            <div className="flex flex-col ml-5 pr-10 pl-4 py-4 rounded-3xl bg-slate-200 w-auto">
              ...
              <p className="font-sans text-base text-left mt-4">
                Đây là một công thức hoàn hảo do đầu bếp 3 sao Michelin Đỗ Quang
                Phúc sáng tạo ra. Thật là tuyệt vời
              </p>
            </div>
          </div>
        </div>
